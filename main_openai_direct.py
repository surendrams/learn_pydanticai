...
# Use OpenAI directly (requires OPENAI_API_KEY in .env)
# Add to .env: OPENAI_API_KEY=your-openai-key-here
# The OpenAIChatModel will automatically read OPENAI_API_KEY from the environment
